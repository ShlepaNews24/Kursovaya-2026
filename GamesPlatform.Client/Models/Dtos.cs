...
{
    public class AuthRequestDto { public string? UserName { get; set; } public string Email { get; set; } = string.Empty; public string Password { get; set; } = string.Empty; }
    ...
    public class GenreDto { [JsonPropertyName("genreId")] public int GenreId { get; set; } [JsonPropertyName("genreName")] public string GenreName { get; set; } = string.Empty; }
    ...
    public class RatingDto { [JsonPropertyName("gameId")] public int GameId { get; set; } [JsonPropertyName("ratingValue")] public int RatingValue { get; set; } }
    public class RatingSummaryDto { [JsonPropertyName("gameId")] public int GameId { get; set; } [JsonPropertyName("averageRating")] public double AverageRating { get; set; } [JsonPropertyName("totalVotes")] public int TotalVotes { get; set; } [JsonPropertyName("userRating")] public int? UserRating { get; set; } }
    public class UpdateUsernameDto { [JsonPropertyName("userName")] public string UserName { get; set; } = string.Empty; }
    public class UpdateDateOfBirthDto { [JsonPropertyName("dateOfBirth")] public DateTime? DateOfBirth { get; set; } }
    
    public class UpdateRoleDto { [JsonPropertyName("userType")] public string UserType { get; set; } = string.Empty; }
    public class UpdateStatusDto { [JsonPropertyName("isActive")] public bool IsActive { get; set; } }
}